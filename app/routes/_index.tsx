          ...
          <div className="flex flex-col items-start gap-8 w-full">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Законодательная база в сфере национальной политики в странах
                  Центральной Азии
                </li>
                <li>
                  Систематизированный научный материал и экспертный опыт в
                  области межнациональных и межконфессиональных отношений на
                  одной информационной площадке.
                </li>
              </ul>
            </div>
          </div>
